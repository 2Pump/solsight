...
export default function AuthPage() {
  ...
  // useWallets/useSignMessage come from the dedicated
  // "@privy-io/react-auth/solana" submodule, NOT the main package — the
  // main package's generic useWallets() returns objects that don't expose
  // signMessage directly.
  ...
  async function handleWalletSignIn() {
    ...
    try {
      ...
      // cookie can take a moment to fully commit in the browser. A hard
      // navigation guarantees the fresh cookie is sent with the very next
      // request.
